...
extension ChrisViewController {
    ...
    func createBarButton() {
        let barButton = UIBarButtonItem(title: "⭐️", style: UIBarButtonItem.Style.plain, target: self, action: #selector(showPicker))
        let barButton2 = UIBarButtonItem(title: "👋", style: UIBarButtonItem.Style.plain, target: self, action: #selector(exit))
        let barButton3 = UIBarButtonItem(barButtonSystemItem: UIBarButtonItem.SystemItem.add, target: self, action: nil)
    ...
    func createButton() {
        ...
        /*
         You can give a frame to the Button
         myButton.frame = CGRect(x: 140, y: 280, width: 170, height: 44)
         */
        ...
        // Or you can create Contraints for the UIButton 👇
